 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-1.13.8/b-2.4.2/r-2.5.0/sl-1.7.0
 *
 * Included libraries:
 *   jQuery 3 3.7.0, DataTables 1.13.8, Buttons 2.4.2, Responsive 2.5.0, Select 1.7.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/jq-3.7.0/dt-1.13.8/b-2.4.2/r-2.5.0/sl-1.7.0",
